...
func TestHandleNonStreamingResponseWithMetrics_MultipleToolCalls(t *testing.T) {
	...
	handleNonStreamingResponseWithMetrics(c, resp, core.ChatCompletionRequest{Model: "gpt-4o"}, time.Now(), "acc", m, &core.NopLogger{})
...
func TestHandleStreamingResponseWithMetrics_MultipleToolCalls(t *testing.T) {
	...
	handleStreamingResponseWithMetrics(c, resp, core.ChatCompletionRequest{Model: "gpt-4o", Stream: true}, time.Now(), "acc", m, &core.NopLogger{})
...
func TestHandleNonStreamingResponseWithMetrics_MultipleLegacyFunctionCalls(t *testing.T) {
	...
	var parsed core.ChatCompletionResponse
	...
	if parsed.Choices[0].Message.ToolCalls[0].Function.Name != "legacy_first" {
		t.Fatalf("第一个 legacy function call 名称错误")
	}
}
